...
CONTRIBUTING FACTORS: The write stage contract has no human check. You should
add one after the drafting step so the output is steered before it is finished.
