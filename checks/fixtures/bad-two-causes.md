DIAGNOSIS: Three causes are at work here:
1. the voice rules live in the entry file;
2. the routed style guide is too general;
3. the write stage has no human check.
