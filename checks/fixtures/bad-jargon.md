...
- Deeper step tested and rejected: "the builder did not know the guardrail".
  ...
  sit in this file.
- Shallower step passed over: family 6. The routed guide is 22 lines, so a
  section scope changes nothing.

RULED OUT:
- Family 4: both stage contracts carry Inputs, Process and Outputs.
- Family 10: none outside templates.
